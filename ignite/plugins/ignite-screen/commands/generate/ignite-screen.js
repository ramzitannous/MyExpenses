...
module.exports = {
  ...
  run: async function(toolbox) {
    ...
    const styleName = name.endsWith("-style") ? name : `${name}-style`;
    ...
    const camelName = camelCase(screenName).replace("Screen", "");
    ...
    const jobs = [
      ...
      },
      {
        ...
        target: `app/screens/${screenName}/${styleName}.ts`
      },
      {
        template: `store.js.ejs`,
        target: `app/screens/${screenName}/${storeName}.ts`
      },
      {
